...
//
    ...
    function GetUrlPars() {
        ...
        if (url.indexOf("?") != -1) {
            ...
            // console.log(url);
            strsencode = pageSendDecode(str);
            strs = strsencode.split("&");
    ...
    function pageSendEncode(str) {
        return encodeURI(base64encode(utf16to8(str)));
    }
     ...
     * @param context 
     */
    function pageSendDecode(str) {

        return decodeURI(utf8to16(base64decode(str)));
    }
