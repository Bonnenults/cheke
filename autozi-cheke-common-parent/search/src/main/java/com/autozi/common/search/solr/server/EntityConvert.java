...
public class EntityConvert {
	 ...
	 */
//	public static SolrInputDocument entity2SolrInputDocument1(Object obj) {
//		if (obj != null) {
...
//				     BeanUtils.isSimpleProperty(method.getReturnType()) &&
//				     getValueByMethod(obj,method)!=null){
//					sid.addField(getPropertyName(method), getValueByMethod(obj,method));
//				}
//			}
//			
//			String rid=getRid((IdEntity)obj);
//			sid.addField(ISolrIndex.uniqueKey, rid);
//			return sid;
//		}
...
//	public static String getRid(IdEntity entity){
//		String className=entity.getClass().getName();
//		String id=entity.getId().toString();
//		return className+ISolrIndex.regex+id;
//	}
//	
//	private static Object getValueByMethod(Object obj,Method method){
...
//		String prop = Character.toLowerCase(methodName.charAt(0)) + methodName.substring(1);  
//		return prop+"_s";
//	}
...
//					fieldName=convertFieldName(fieldName);
					...
					Method m = cls.getMethod(getMethodName(fieldName, "set"), fieldType);
	...
	private static String convertFieldName(String fieldName) {
		if(fieldName!=null && !fieldName.equals(ISolrIndex.uniqueKey)){
	 ...
	 */
//	public static <T> Collection<SolrInputDocument> entityList2SolrInputDocument1(List<T> entityList) {
