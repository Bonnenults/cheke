...
public class CachingExecutor implements Executor {
    ...
    if (cache != null) {
      ...
      if (ms.isUseCache() && resultHandler == null) { 
        ...
        if (!dirty) {
          ...
          } catch(Exception exc){//when cache can not work, mybatis should work
        	  exc.printStackTrace();
          }finally {
  ...
  private void flushCacheIfRequired(MappedStatement ms) {
	...
	public void deferLoad(MappedStatement arg0, MetaObject arg1, String arg2,
			CacheKey arg3, Class<?> arg4) {
