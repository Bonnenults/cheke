...
public class B2bMallMemClient {
	private static String memcachedNodes = PropertyUtils.getValue("com.autozi.b2b.mall.memcached.servers");
	private static String poolName = "com.autozi.b2b.mall.memcached.servers";
	...
	private static B2bMallMemClient instatic = new B2bMallMemClient();
	
	public B2bMallMemClient(){
		if(mcc==null){
			createMcc();
		}
	}
	
	public static B2bMallMemClient getInstance(){
		return instatic;
	}
