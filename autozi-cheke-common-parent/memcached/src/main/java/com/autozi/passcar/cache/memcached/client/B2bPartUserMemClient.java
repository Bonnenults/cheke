...
public class B2bPartUserMemClient {
	private static String memcachedNodes = PropertyUtils.getValue("com.autozi.b2b.partvsuser.memcached.servers");
	private static String poolName = "com.autozi.b2b.partvsuser.memcached.servers";
	...
	private static B2bPartUserMemClient instatic = new B2bPartUserMemClient();
	
	public B2bPartUserMemClient(){
		if(mcc==null){
			createMcc();
		}
	}
	
	public static B2bPartUserMemClient getInstance(){
		return instatic;
	}
