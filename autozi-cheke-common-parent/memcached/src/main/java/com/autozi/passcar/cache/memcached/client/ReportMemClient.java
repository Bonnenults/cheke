...
public class ReportMemClient {
	private static String memcachedNodes = PropertyUtils.getValue("com.autozi.report.memcached.servers");
	private static String poolName = "com.autozi.report.memcached.servers";
	...
	private static ReportMemClient instatic = new ReportMemClient();
	
	public ReportMemClient(){
		if(mcc==null){
			createMcc();
		}
	}
	
	public static ReportMemClient getInstance(){
		return instatic;
	}
