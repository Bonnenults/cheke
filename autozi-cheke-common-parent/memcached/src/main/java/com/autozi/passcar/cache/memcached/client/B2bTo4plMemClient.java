...
/**
 * Created by 刘兵 on 2016/10/18.
 */
@Deprecated
public class B2bTo4plMemClient {
    private static String memcachedNodes = PropertyUtils.getValue("com.autozi.b2b.4pl.memcached.servers");
    private static String poolName = "com.autozi.b2b.4pl.memcached.servers";
    ...
    private static B2bTo4plMemClient instatic = new B2bTo4plMemClient();

    public B2bTo4plMemClient(){
        if(mcc==null){
            createMcc();
        }
    }

    public static B2bTo4plMemClient getInstance(){
        return instatic;
    }
