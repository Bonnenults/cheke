...
public class UserCenterMemClient {
	private static String memcachedNodes = PropertyUtils.getValue("com.autozi.usercenter.memcached.servers");
	private static String poolName = "com.autozi.usercenter.memcached.servers";
	...
	private static UserCenterMemClient instatic = new UserCenterMemClient();
	
	public UserCenterMemClient(){
		if(mcc==null){
			createMcc();
		}
	}
	
	public static UserCenterMemClient getInstance(){
		return instatic;
	}
