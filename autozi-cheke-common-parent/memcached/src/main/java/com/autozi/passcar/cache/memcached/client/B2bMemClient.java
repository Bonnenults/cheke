...
public class B2bMemClient {
	...
	private static B2bMemClient instatic = new B2bMemClient();
	...
	public static B2bMemClient getInstance(){
		return instatic;
	}
