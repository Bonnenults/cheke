...
public class ImgUtil {
    ...
    public void reduceImageByRatio(String srcImagePath,String toImagePath,int widthRatio,int heightRatio) throws IOException{  
        ...
        try{  
            ...
            String _suf_name = srcImagePath.substring(srcImagePath.lastIndexOf(".") + 1);
            ImageIO.write(tag, _suf_name, out);
...
//            encoder.encode(tag);    
    ...
    public void mergeBothImage(String negativeImagePath,String additionImagePath,int x,int y,String toPath ) throws IOException{  
        ...
        try{  
            ...
            String _suf_name = additionImagePath.substring(additionImagePath.lastIndexOf(".") + 1);
            ImageIO.write(image, _suf_name, os);
...
//                          .getHeight() / 2);  
    ...
    /**
     * @description 上传图片并加水印 
     * @param inputStream 待上传图片的输入流
     * @param appendImagePath 水印图片路径
     * @param alpha 透明度
     * @param x  水印图片的起始x坐标
     * @param y  水印图片的起始y坐标
     ...
     * @date 2015-01-28
     */
    public static void alphaImage2Image(InputStream inputStream , String appendImagePath,  
            float alpha,int x,int y,String imageFormat,String toPath) throws IOException{  
        FileOutputStream fos = null;  
        try { 
            ...
            //设置水印图片的起始x/y坐标、宽度、高度  
            BufferedImage appendImage = ImageIO.read(new File(appendImagePath));             
            g2d.drawImage(appendImage, x, y, image.getWidth(), image.getHeight(), null, null);  
            g2d.dispose();  
            fos=new FileOutputStream(toPath);  
            ImageIO.write(image, imageFormat, fos);  
        } catch (Exception e) {  
    ...
    public static int getImgHeight(String srcImagePath) throws IOException{
    	BufferedImage image = ImageIO.read(new File(srcImagePath));  
    	return image.getHeight();
    }
    public static int getImgWidth(String srcImagePath) throws IOException{
    	BufferedImage image = ImageIO.read(new File(srcImagePath));  
    	return image.getWidth();
    }
    
    public static int getImgSize(String srcImagePath) throws IOException{
    	BufferedImage image = ImageIO.read(new File(srcImagePath));  
    ...
    public static void main(String[] args)throws Exception{  
        ...
        */  
        ...
        /**/String srcImagePath = "c:/cspic/01.JPG";
        String appendImagePath = "c:/ss1.png";
//        String appendImagePath = "c:/s2.gif";
        float alpha = 1F;
//        String  font = "宋体";
...
//        String inputWords = "图片上设置水印文字 ---- 宋体 普通字体 32号字 红色 透明度0.5";
        ...
        int y = 0;
        String imageFormat = "jpg";
        String toPath = "C:/shuiyin.png";
//        imageObj.alphaWords2Image(srcImagePath, alpha, font, fontStyle, fontSize, color, inputWords, x, y, imageFormat, toPath); //设置文字水印
        alphaImage2Image(srcImagePath, appendImagePath, alpha, x, y, 960, 960, imageFormat, toPath);//设置图片水印
