...
public class ImageUtils {
   ...
   static{
     ...
     * 上传头像处理
     */
    public static void scale(InputStream inputStream, String path, String bgPath) {
        int width = 0;
        int height = 0;
        try {
            ...
            if ((double) width / height >= 1) {
                if (width > 300) {
                    width = 300;
                    height = (int) (height * (300.0 / src.getWidth()));
                }
            } else {
                if (height > 300) {
                    height = 300;
                    width = (int) (width * (300.0 / src.getHeight()));
                }
            }
...
//     * @throws IOException
//     */
//    private static void mergeImage(BufferedImage image1, BufferedImage image2, String path) throws IOException {
//        Graphics g = image1.getGraphics();
//        g.drawImage(image2, (image1.getWidth() - image2.getWidth()) / 2, (image1.getHeight() - image2.getHeight()) / 2, null);
//        OutputStream out = new FileOutputStream(createParentFile(path));
...
//    }
    ...
    public static String uploadToTemp(MultipartFile file) {
        ...
        File target = createParentFile(tempPath + "temp/" + newFileName);
        try {
            file.transferTo(target);
            return serverPath + "temp/" + newFileName;
