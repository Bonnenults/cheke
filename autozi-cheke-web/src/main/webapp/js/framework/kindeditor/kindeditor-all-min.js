    ...
    function(window, undefined) {
        ...
        if (!window.KindEditor) {
            ...
            KEditor.prototype = {
                ...
                text: function(a) {
                    var b = this;
                    return a === undefined ? _trim(b.html().replace(/<(?!img|video).*?>/gi, "").replace(/&nbsp;/gi, " ")) : b.html(_escape(a))
                },
                isEmpty: function() {
                ...
                count: function(a) {
                    ...
                    return a = (a || "html").toLowerCase(),
                        "html" === a ? b.html().length: "text" === a ? b.text().replace(/<(?:img|video).*?>/gi, "K").replace(/\r\n|\n|\r/g, "").length: 0
                },
                exec: function(a) {
                    a = a.toLowerCase();
                    var b = this,
